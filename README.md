...
| OpenAI Computer-Using Agent (CUA) family | 2025–2026 | [![Docs](https://img.shields.io/badge/Docs-OpenAI_CUA-2563eb?logo=readthedocs&logoColor=white)](https://platform.openai.com/docs/guides/tools-computer-use) | Product-level reference for how frontier models are wired into computer-use agent loops |
